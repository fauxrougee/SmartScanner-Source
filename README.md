...
The [assets/default-scan-config.json](assets/default-scan-config.json) file provides the default configuration: enabled modules, HTTP timeouts, parallel requests, crawling, exclusions, authentication, and form parameters.
